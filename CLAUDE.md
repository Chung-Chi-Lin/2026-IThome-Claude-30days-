...
- ~~Sonnet 5 的 $2/$10 導入價於 2026-08-31 到期，9 月鐵人賽期間應為標準價 $3/$15~~
  → **已於 2026-08-19 查證：這件事沒有照原訂計畫發生。** 官方公告 $2/$10 直接轉為
  **標準價（不再是導入優惠）**，原訂 2026-09-01 起漲到 $3/$15 的計畫**已取消，不會發生**。
  這是本系列從第一天就標記的高風險項目，這次真的變動了，但方向跟預期相反（是優惠轉正，
  不是漲價）。**所有提到 Sonnet 5 是「$3/$15（導入價 $2/$10）」的段落都需要訂正**，
  已知涉及：CLAUDE.md 本節表格、`day1`、`day2`、`day10`、`PROGRESS.md`。
...
| Claude Sonnet 5 | `claude-sonnet-5` | $2 / $10（原導入價，2026-08-19 起確認為標準價，9/1 調漲計畫已取消） | 平衡 |
...
- Day29　Vibecoding 做出網站之後：AI 不會主動告訴你的那些事
