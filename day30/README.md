...
**主線三：怎麼問、以及怎麼判斷答案可不可信**（Day 17-20 的 prompt 與防幻覺，Day 29 收在「你不知道要問什麼」的盲區）→ 這條線不是知識本身，是**取得所有知識時該有的警覺**。
...
謝謝你讀到這裡。如果這系列對你有幫助，歡迎透過開頭的 Email 告訴我；如果你發現任何過期或該修正的地方，也請不吝指正——這正呼應 Day 29 的那句話，**「它講得很順」不能當作「它講得對」的證據**，而這篇文章本身，以後也需要被重新檢查。
